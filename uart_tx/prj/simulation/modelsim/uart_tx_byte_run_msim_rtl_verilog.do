...
vlog -vlog01compat -work work +incdir+D:/gitwork/FPFA_EXC/uart_tx/rtl {D:/gitwork/FPFA_EXC/uart_tx/rtl/uart_tx_byte.v}

vlog -vlog01compat -work work +incdir+D:/gitwork/FPFA_EXC/uart_tx/prj/../testbench {D:/gitwork/FPFA_EXC/uart_tx/prj/../testbench/uart_tx_byte_tb.v}

vsim -t 1ps -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L cycloneive_ver -L rtl_work -L work -voptargs="+acc"  uart_tx_byte_tb
