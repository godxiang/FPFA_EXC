...
vlog -vlog01compat -work work +incdir+D:/gitwork/FPFA_EXC/adc/rtl {D:/gitwork/FPFA_EXC/adc/rtl/adc_18s022.v}

vlog -vlog01compat -work work +incdir+D:/gitwork/FPFA_EXC/adc/prj/../testbench {D:/gitwork/FPFA_EXC/adc/prj/../testbench/adc_18s022_tb.v}

vsim -t 1ps -L altera_ver -L lpm_ver -L sgate_ver -L altera_mf_ver -L altera_lnsim_ver -L cycloneive_ver -L rtl_work -L work -voptargs="+acc"  adc_18s022_tb
